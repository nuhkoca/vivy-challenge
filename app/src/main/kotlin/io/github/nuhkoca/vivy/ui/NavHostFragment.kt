...
/**
 * A custom [NavHostFragment] to allow [VivyFragmentFactory] to inflate fragments using this host.
 */
@MainScope
class NavHostFragment : NavHostFragment() {
    ...
    override fun onAttach(context: Context) {
        vivyApplication.appComponent.mainComponent().create().inject(this)
